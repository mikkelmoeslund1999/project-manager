...
const initProjects = [
  { id: "p1", name: "Platform Redesign", description: "Complete UI/UX overhaul of the customer platform", status: "on_track", owner: "u1", createdAt: "2025-12-01", deadline: "2026-04-15", color: "#6366f1" },
  { id: "p2", name: "Mobile App v2", description: "Native mobile application rebuild with React Native", status: "at_risk", owner: "u2", createdAt: "2026-01-10", deadline: "2026-05-30", color: "#ec4899" },
  { id: "p3", name: "API Migration", description: "Migrate legacy REST endpoints to GraphQL", status: "behind", owner: "u1", createdAt: "2025-11-15", deadline: "2026-03-20", color: "#f59e0b" },
  { id: "p4", name: "Analytics Dashboard", description: "Real-time analytics and reporting dashboard", status: "on_track", owner: "u3", createdAt: "2026-02-01", deadline: "2026-06-01", color: "#10b981" },
];

const initTasks = [
  { id: "t1", title: "Design system audit", description: "Review all existing components and document inconsistencies", status: "Done", priority: "high", assigneeId: "u2", projectId: "p1", dueDate: "2026-02-20", estimatedHours: 16, tags: ["design"], subtasks: 4, subtasksDone: 4, order: 0 },
  { id: "t2", title: "Component library setup", description: "Initialize Storybook and create base primitives", status: "In Progress", priority: "critical", assigneeId: "u1", projectId: "p1", dueDate: "2026-03-10", estimatedHours: 24, tags: ["frontend"], subtasks: 6, subtasksDone: 3, order: 1 },
  { id: "t3", title: "Navigation redesign", description: "New sidebar + top nav with responsive breakpoints", status: "To Do", priority: "high", assigneeId: "u3", projectId: "p1", dueDate: "2026-03-18", estimatedHours: 20, tags: ["design"], subtasks: 3, subtasksDone: 0, order: 2 },
  { id: "t4", title: "Auth flow screens", description: "Login, signup, forgot password, MFA screens", status: "Backlog", priority: "medium", assigneeId: "u4", projectId: "p1", dueDate: "2026-03-25", estimatedHours: 12, tags: ["auth"], subtasks: 5, subtasksDone: 0, order: 3 },
  { id: "t5", title: "React Native scaffolding", description: "Project setup with Expo and navigation structure", status: "In Progress", priority: "critical", assigneeId: "u2", projectId: "p2", dueDate: "2026-03-05", estimatedHours: 8, tags: ["mobile"], subtasks: 3, subtasksDone: 2, order: 0 },
  { id: "t6", title: "Push notification service", description: "Integrate Firebase Cloud Messaging", status: "To Do", priority: "high", assigneeId: "u4", projectId: "p2", dueDate: "2026-03-20", estimatedHours: 16, tags: ["backend"], subtasks: 4, subtasksDone: 0, order: 1 },
  { id: "t7", title: "Offline sync engine", description: "Implement local-first data sync with conflict resolution", status: "Backlog", priority: "medium", assigneeId: "u1", projectId: "p2", dueDate: "2026-04-10", estimatedHours: 32, tags: ["data"], subtasks: 7, subtasksDone: 0, order: 2 },
  { id: "t8", title: "Schema migration plan", description: "Document all REST endpoints and map to GraphQL schema", status: "Review", priority: "critical", assigneeId: "u1", projectId: "p3", dueDate: "2026-02-28", estimatedHours: 20, tags: ["backend"], subtasks: 5, subtasksDone: 4, order: 0 },
  { id: "t9", title: "Resolver implementation", description: "Build GraphQL resolvers for user and project domains", status: "In Progress", priority: "high", assigneeId: "u3", projectId: "p3", dueDate: "2026-03-15", estimatedHours: 40, tags: ["graphql"], subtasks: 8, subtasksDone: 3, order: 1 },
  { id: "t10", title: "Client SDK update", description: "Generate typed client from GraphQL schema", status: "Backlog", priority: "medium", assigneeId: "u5", projectId: "p3", dueDate: "2026-04-01", estimatedHours: 12, tags: ["frontend"], subtasks: 3, subtasksDone: 0, order: 2 },
  { id: "t11", title: "Data pipeline design", description: "Design ETL pipeline for analytics ingestion", status: "In Progress", priority: "high", assigneeId: "u3", projectId: "p4", dueDate: "2026-03-12", estimatedHours: 24, tags: ["data"], subtasks: 5, subtasksDone: 2, order: 0 },
  { id: "t12", title: "Chart components", description: "Build reusable chart primitives with Recharts", status: "To Do", priority: "medium", assigneeId: "u4", projectId: "p4", dueDate: "2026-03-22", estimatedHours: 18, tags: ["charts"], subtasks: 6, subtasksDone: 0, order: 1 },
  { id: "t13", title: "Real-time websocket layer", description: "SSE or WebSocket connection for live dashboard updates", status: "Backlog", priority: "low", assigneeId: "u1", projectId: "p4", dueDate: "2026-04-15", estimatedHours: 14, tags: ["realtime"], subtasks: 4, subtasksDone: 0, order: 2 },
  { id: "t14", title: "Performance benchmarks", description: "Load testing and query optimization for analytics queries", status: "Backlog", priority: "low", assigneeId: "u5", projectId: "p4", dueDate: "2026-04-20", estimatedHours: 10, tags: ["testing"], subtasks: 3, subtasksDone: 0, order: 3 },
];

const initComments = [
  { id: "c1", content: "Audit complete — found 47 inconsistencies across 12 component families.", authorId: "u2", taskId: "t1", createdAt: "2026-02-18T10:30:00" },
  { id: "c2", content: "Great work Sara. Let's prioritize the typography and color token issues first.", authorId: "u1", taskId: "t1", createdAt: "2026-02-18T11:15:00" },
  { id: "c3", content: "Storybook is set up. Working on Button, Input, and Card primitives now.", authorId: "u1", taskId: "t2", createdAt: "2026-03-02T09:00:00" },
  { id: "c4", content: "Schema doc is ready for review. 38 endpoints mapped to 12 types.", authorId: "u1", taskId: "t8", createdAt: "2026-02-26T14:00:00" },
  { id: "c5", content: "Pipeline architecture looks solid. Suggesting a dead letter queue.", authorId: "u1", taskId: "t11", createdAt: "2026-03-08T16:00:00" },
];

const initActivities = [
  { id: "a1", type: "task_completed", userId: "u2", projectId: "p1", taskId: "t1", meta: { title: "Design system audit" }, createdAt: "2026-03-05T08:30:00" },
  { id: "a2", type: "task_moved", userId: "u1", projectId: "p1", taskId: "t2", meta: { from: "To Do", to: "In Progress" }, createdAt: "2026-03-04T17:00:00" },
  { id: "a3", type: "comment_added", userId: "u1", projectId: "p3", taskId: "t8", meta: { preview: "Schema doc is ready..." }, createdAt: "2026-03-04T14:00:00" },
  { id: "a4", type: "task_created", userId: "u3", projectId: "p4", taskId: "t11", meta: { title: "Data pipeline design" }, createdAt: "2026-03-03T10:00:00" },
  { id: "a5", type: "member_joined", userId: "u5", projectId: "p3", taskId: null, meta: { name: "Erik Poulsen" }, createdAt: "2026-03-02T08:00:00" },
  { id: "a6", type: "task_moved", userId: "u2", projectId: "p2", taskId: "t5", meta: { from: "To Do", to: "In Progress" }, createdAt: "2026-03-02T11:00:00" },
  { id: "a7", type: "deadline_warning", userId: "u1", projectId: "p3", taskId: "t8", meta: { title: "Schema migration plan", days: 2 }, createdAt: "2026-03-01T08:00:00" },
  { id: "a8", type: "comment_added", userId: "u1", projectId: "p4", taskId: "t11", meta: { preview: "Pipeline architecture..." }, createdAt: "2026-02-28T16:00:00" },
];
...
const Sidebar = ({ view, setView, dark, setDark, projects, mobOpen, setMobOpen }) => {
  const nav = [
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)" }}>
      ...
      <Sidebar view={view} setView={setView} dark={dark} setDark={setDark} projects={projects} mobOpen={mobOpen} setMobOpen={setMobOpen} />
